...
*   **Control de Acceso:** Si el proyecto implementa autenticación, todo endpoint privado debe requerir autenticación y autorización robusta. Proyectos sin autenticación deben asegurar el acceso mediante restricciones de red. Cero credenciales hardcodeadas.
...
*   **Formato de Eventos:** Todo evento debe tener un esquema claro y versionado. En proyectos con **RabbitMQ**, los mensajes se definen como DTOs en el paquete `infrastructure/event/` y se documentan usando AsyncAPI.
