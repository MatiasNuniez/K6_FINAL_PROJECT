---
name: generate-spec
description: Genera una especificación técnica ASDD para un nuevo feature. Usa este comando con el nombre y descripción del feature.
...
- Comunicación asíncrona RabbitMQ (si aplica entre microservicios)
- Plan de tests unitarios (JUnit 5) y QA
